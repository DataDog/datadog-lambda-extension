...
The same feature gates the embedded `bottlecap::fake_intake` module used by the `apm_integration_test` and `dsm_integration_test` integration tests, which are skipped by default-feature test runs.
