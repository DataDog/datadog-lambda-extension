...
impl Provider {
    ...
    #[must_use]
    pub fn get_log_tags_string(&self) -> String {
        self.tag_provider.get_log_tags_vec().join(",")
    }
...
trait GetTags {
    ...
    fn get_log_tags_vec(&self) -> Vec<String>;
...
impl GetTags for TagProvider {
    ...
    fn get_log_tags_vec(&self) -> Vec<String> {
        match self {
            TagProvider::Lambda(lambda_tags) => lambda_tags.get_log_tags_vec(),
        }
    }
