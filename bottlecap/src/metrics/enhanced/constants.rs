// Pricing constants
pub const BASE_LAMBDA_INVOCATION_PRICE: f64 = 0.0000002;
pub const X86_LAMBDA_PRICE_PER_GB_SECOND: f64 = 0.0000166667;
pub const ARM_LAMBDA_PRICE_PER_GB_SECOND: f64 = 0.0000133334;
