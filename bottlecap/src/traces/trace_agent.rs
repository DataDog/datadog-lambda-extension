...
pub struct TraceState {
    ...
    pub invocation_processor: InvocationProcessorHandle,
...
impl TraceAgent {
    ...
    async fn handle_traces(
        ...
        let mut reparenting_info = match invocation_processor.get_reparenting_info().await {
            Ok(info) => info,
            Err(e) => {
                return error_response(
                    StatusCode::INTERNAL_SERVER_ERROR,
            ...
            for span in chunk.iter_mut() {
                ...
                if span.name == LAMBDA_LOAD_SPAN {
                        ...
                        .await
                    {
                        ...
                        Ok(None) => {
                            // No cold start span ID returned
                        }
                        Err(e) => {
